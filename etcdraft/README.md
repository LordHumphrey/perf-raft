...
```bash
# 启动单节点
./etcdraft -id node1 -raft-addr localhost:12000 -http-addr localhost:2379 -data-dir ./data/node1

# 启动集群中的其他节点
./etcdraft -id node2 -raft-addr localhost:12001 -http-addr localhost:2380 -data-dir ./data/node2 -join localhost:2379
./etcdraft -id node3 -raft-addr localhost:12002 -http-addr localhost:2381 -data-dir ./data/node3 -join localhost:2379
```
